...
public (string version, string versionPack, string versionRelease) RunUpdateVersion(string version, string packageFlow)
{
    ...
    return (version, versionPack, versionRelease);
}
